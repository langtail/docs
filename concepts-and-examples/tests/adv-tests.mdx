...
<Note>  Familiarity with [Basic Tests](/tutorials/tests/basic-tests) is assumed.</Note>
...
<Tip>This guide focuses on Langtail's advanced testing features. To learn more about the various assertion types available and their respective use cases, refer to the [Tests Overview](/tutorials/tests/overview) section.</Tip>

<iframe
  width="720"
  height="400"
  src="https://www.youtube.com/embed/sMGLqpYNYtI?si=-ImMV43W9nAhN9rj"
...
3. Create a few user messages that will be sent, you can either create them manually or use our ✨ magic button in the left right corner to create those for you.
