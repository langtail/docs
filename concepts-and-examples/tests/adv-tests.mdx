...
<Steps>
  <Step title="Set up the test suite">
    ...
    3. Navigate to 'Tests' tab and open an existing Test or create a new one.

    4. Create a few user messages that will be sent, you can either create them manually or use our ✨ magic button in the left right corner to create those for you.

    5. Fill out variable values.
  </Step>
