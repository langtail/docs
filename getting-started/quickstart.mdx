...
<Steps>
  ...
  <Step title="Create a prompt">
    ...
    1. [Click here](https://app.langtail.com/playground?shareid=WIkC5AugdE) to open the quickstart prompt.
    1. In the top right, click "Save as..."
    1. Select your new project, rename the prompt, and click "Save".
