...
![Screenshot of configs in Langtail](/images/tests/advanced/configs.png)
...
### Video Guide
- Embed or link to a video guide demonstrating the entire process of testing the movie recommendation prompt
