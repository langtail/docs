...
<Steps>
  ...
  <Step title="Create a basic test">
    <video controls className="w-full aspect-video" src="/images/quickstart/step4.mp4" />
    ...
    5. Use the magic button in the botton to create 5 more example values.

    6. Select "New Assertion", then "contains".
