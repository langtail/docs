...
- Concepts and Examples section
- How to Guides section
- Technical Reference
- Explanations section

<iframe
  src="https://app.supademo.com/embed/cm19a4oye0g58ououtwxex1bg?embed_v=2"
  loading="lazy"
  title="Supademo Demo"
...
The Concepts and Examples section is designed for beginners or those new to Langtail. It explains features in detail and provides step-by-step guides that walk you through the installation process, setup, and basic usage of Langtail. These interactive examples are hands-on, allowing you to learn by doing.
