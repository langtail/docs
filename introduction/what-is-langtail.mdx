...
<Tabs>
  <Tab title="Langtail as a Proxy">
    <Frame>
      <img src="/images/quickstart/proxy.png" alt="Langtail schema with proxy solution" />
    </Frame>
  </Tab>
  <Tab title="Proxyless solution">
    <Frame>
      <img src="/images/quickstart/proxyless.png" alt="Langtail schema with proxyless solution" />
    </Frame>
  </Tab>
  </Tabs>
