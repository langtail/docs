---
title: 'Use templates in a prompt'
...
would print the current date in the format `MMMM dd, yyyy`.

```django Example
{{$date "yyyy"}}
```
use yyyy to print the current year
...
{{$date "2024-09-01" "MM"}}
```
to print the month of a specific date
