...
If you've already started building your application by using OpenAI's models via Langchain but want to start experimenting with Langtail, you can configure your existing code to start sending requests to Langtail's proxy.
