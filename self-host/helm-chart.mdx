...
LANGTAIL_MAGIC_TOKEN: "your-langtail-magic-token"
LANGTAIL_MAGIC_TESTS_TOKEN: "your-langtail-magic-tests-token"

PRISMA_FIELD_ENCRYPTION_KEY: "your-prisma-field-encryption-key"
IMAGES_AWS_SECRET_ACCESS_KEY: "your-aws-secret-access-key"
```
