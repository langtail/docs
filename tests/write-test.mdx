...
A **case** is a user message that is added to the prompt before it is executed in a test run.
...
![Screenshot of Langtail's test section](/images/tests/write-test/screenshot2.png)
